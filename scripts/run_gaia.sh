#!/bin/bash
# GCRI GAIA Benchmark Runner
# Usage: ./run_gaia.sh [ato_args...] [inspect_args...]
# Example: ./run_gaia.sh agents.strategy_generator.model_id=openai/gpt-4o --limit 10
...
source .venv/bin/activate
PYTHONPATH=. inspect eval gcri/benchmark/gaia.py "${INSPECT_ARGS[@]}"
