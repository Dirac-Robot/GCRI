#!/bin/bash
# GCRI WritingBench Benchmark Runner (Model Provider)
...
echo ""
echo "✍️ Running WritingBench Benchmark..."
echo "═══════════════════════════════════════════════════════════"
PYTHONPATH=. inspect eval inspect_evals/writingbench --model gcri/gcri "${INSPECT_ARGS[@]}"
